...
public class AnswersRepository {
    ...
    private static class InsertAnswerAsyncTask extends AsyncTask<Answers, Void, Void> {
        private AnswersDao answersDao;
        private InsertAnswerAsyncTask(AnswersDao userDao) {
            this.answersDao = answersDao;
        }
        @Override
        protected Void doInBackground(Answers... answer) {
    ...
    // Must user AsyncTask because room doesn't allow make operation on the main thread. Only LiveData Room execute it in the background by default
    private static class UpdateAnswerAsyncTask extends AsyncTask<Answers, Void, Void> {
        private AnswersDao answersDao;
    ...
    // Must user AsyncTask because room doesn't allow make operation on the main thread. Only LiveData Room execute it in the background by default
    private static class DeleteAnswerAsyncTask extends AsyncTask<Answers, Void, Void> {
        private AnswersDao answersDao;
    ...
    // Must user AsyncTask because room doesn't allow make operation on the main thread. Only LiveData Room execute it in the background by default
    private static class DeleteAllAsyncTask extends AsyncTask<Answers, Void, Void> {
        private AnswersDao answersDao;
